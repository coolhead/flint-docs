...
connector_name_response = @call.connector("connector_name")
                               .set("target","IP/hostname") #Target machine hostname or ip address
                               .set("port",22)              #Target machine port,default 22
                               .set("type","exec")          #Shell execution type:shell or exec,default exec
                               .set("username","username")  #Target machine username
                               .set("password","password")  #Target machine password
                               .set("passphrase","1234")    #Optional passphrase to be added to ssh key
                               .set("key-file","id_rsa")    #Optional ssh key file absolute path
                               .set("command","command")    #Command to be executed on target machine
